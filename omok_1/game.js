...
function renderBoard() {
    ...
    if (!boardElement) {
        console.error("오목판 요소를 찾을 수 없습니다.");
        return;
    }
    ...
    boardElement.style.width = "min(92vw, 700px)";
    boardElement.style.height = "min(92vw, 700px)";
    boardElement.style.aspectRatio = "1 / 1";

    boardElement.style.boxSizing = "border-box";
    boardElement.style.overflow = "hidden";

    boardElement.style.backgroundColor = "#d9b36c";

    boardElement.style.border = "3px solid #5c421f";

    // 기존 CSS의 grid 영향을 제거
    boardElement.style.gridTemplateColumns = "none";
    boardElement.style.gridTemplateRows = "none";
    ...
    */
    ...
    boardElement.style.backgroundSize =
        "calc(100% / 19) calc(100% / 19)";

    boardElement.style.backgroundPosition =
        "calc(100% / 38) calc(100% / 38)";
    ...
    const board =
        normalizeBoard(currentRoom.board);
    ...
    Object.values(guesses).forEach(position => {
        ...
        for (
            ...
            */
            ...
            if (
                ...
                /*
                   기존 CSS를 무시하고
                   이 칸 안에서만 돌이 만들어지도록 합니다.
                */

                stone.style.position = "absolute";

                stone.style.width = "76%";
                stone.style.height = "76%";
                ...
                stone.style.boxSizing =
                    "border-box";

                stone.style.zIndex = "10";

                stone.style.pointerEvents =
                    "none";
            ...
            if (
                ...
                marker.style.width = "35%";
                marker.style.height = "35%";
